...
output "lakehouse_container_id" {
  description = "ARM resource ID, for scoping RBAC role assignments to just this container"
  value       = azurerm_storage_container.lakehouse.id
}
